const  kanzbot = 'KanzBOT'; // Nama Bot Whatsapp
const instagram = 'gpunya'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6282252452100'; // Nomor whatsapplu cok
const aktif = 'Jam 8:00 - 1wita'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/FIr6dblFcvmHvZDRuqBXTA'; // OFFICIAL GRUP LU 1
const youtube = 'Faxez Gaming'; 
...
conn.sendMessage(id, 'Aku BOT nya KanzBOT' ,MessageType.text);
}
else if (text == 'audio'){
...
axios.get(`http://scrap.terhambar.com/tiktokfull?link=${tictoc}`).then((res) => {
	 conn.sendMessage(id, '[WAIT] Searching...🔍', MessageType.text)
     let titoe = `🔍Berhasil di siapkan Silahkan klik link dibawah ini untuk mendownload hasilnya \nKlik link dibawah😀\n\nJudul: ${res.data.deskripsi} \n\nDurasi: ${res.data.durasi}\n\nNama: ${res.data.nama}\n\nUrl: ${res.data.urlvideo}`;
